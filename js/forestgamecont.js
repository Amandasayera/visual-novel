...
function preload() {
    this.load.image('background', './img/growtest.png');
    this.load.image('player', './img/orb1.png');
    this.load.image('foreground', './img/transparent_foreground.png');
    this.load.image('wormholebuttonbutton', './img/wormholebutton.png'); // Adjust the path accordingly
    this.load.image('mushroomyesbutton', './img/mushroomyesbutton.png'); // Adjust the path accordingly
...
function create() {
    ...
    const button1 = this.add.image(8944, 800, 'wormholebuttonbutton');
    ...
    button1.on('pointerdown', function () {
        ...
        window.location.href = 'forestgamefinal.html';
    });
    ...
    const button3 = this.add.image(90, 90, 'arrow');
